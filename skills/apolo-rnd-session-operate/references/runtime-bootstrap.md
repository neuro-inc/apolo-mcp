...
Follow the
[runtime toolchain installation](../../../docs/getting-started/installation.md#runtime-toolchain-inside-an-rd-job).
It owns the pinned-image recommendation, two-stage resolver bootstrap, reviewed package
commands, coding-client installation, and version verification. This skill reference
contains only the non-secret handoff contract below.
